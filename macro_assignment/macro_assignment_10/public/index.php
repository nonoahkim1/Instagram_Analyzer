...
<html lang="en-us">
  ...
  <body>
    ...
    <div id="save">
      Filename:
      <input type="text" id="canvas_name">
      <button id="saveBtn">Save</button>
    </div>
    <p class="hidden" id="error">Invalid Filename</p>
    <p class="hidden" id="saved">File Saved</p>
    <a href="viewmaps.php" id="maps">View Maps</a>
    ...
    const canvas_name = document.getElementById("canvas_name");
    ...
    saveBtn.onclick = function() {
      let first = canvas.firstChild;
      map = "";
      while (first) {
        if (first.firstChild != null) {
          map += first.firstChild.src;
          //console.log(first.firstChild.src)
        }
        //else {
          map += "Blank";
          //console.log("null")
