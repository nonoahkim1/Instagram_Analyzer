...
function renderFollowingTable(followingByMonth) {
    ...
    years.forEach(year => {
        ...
        for (let month = 0; month < 12; month++) {
            ...
            if (highlightEnabled) {
                if (count === minCount) {
                    monthCell.style.backgroundColor = '#FF8080'; // Highlight least following gained month
                } else if (count === maxCount) {
                    monthCell.style.backgroundColor = '#C7F6C7'; // Highlight most following gained month
                } else {
